...
// ============================================================
// خدمات التصميم المعروضة على التاجر — عدّل الأسعار من هون
// ============================================================
export const serviceCurrency = "$";
export const services = [
  { name: "موقع متجر احترافي", desc: "صفحة واحدة سريعة وأنيقة، متجاوبة مع الموبايل، باسم متجرك وألوانك.", price: 120, featured: true },
  { name: "مساعد ذكي (بوت)", desc: "يرد على زبائنك ٢٤/٧ بالعربي والتركي والإنجليزي: أسعار، توصيل، استفسارات.", price: 80, featured: true },
  { name: "صور منتجات احترافية", desc: "صور عالية الجودة لمنتجاتك بالذكاء الاصطناعي — بدون جلسة تصوير.", price: 5, unit: "/ صورة" },
  { name: "أزرار طلب واتساب", desc: "زر طلب مباشر لكل منتج يفتح واتساب برسالة جاهزة.", price: 0 },
  { name: "استضافة ونشر", desc: "رفع الموقع أونلاين برابط خاص + تجديد سنوي.", price: 30, unit: "/ سنة" },
  { name: "تحسين الظهور بجوجل (SEO)", desc: "إعداد الموقع ليظهر بنتائج البحث ويُشارك بشكل جذّاب.", price: 40 },
];
