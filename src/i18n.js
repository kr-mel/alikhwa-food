...
export const UI = {
  ar: {
    ...
    services: { eyebrow: "الخدمات والأسعار", title: "شو بنقدّملك؟", note: "اختر اللي بناسبك — كل خدمة بسعرها.", free: "مشمول مجاناً", featured: "الأكثر طلباً", disclaimer: "* الأسعار قابلة للتفاوض — والمفاصلة سُنّة 🙂" },
  ...
  tr: {
    ...
    services: { eyebrow: "Hizmetler & Fiyatlar", title: "Size ne sunuyoruz?", note: "Size uygun olanı seçin — her hizmet kendi fiyatıyla.", free: "Ücretsiz dahil", featured: "En çok tercih edilen", disclaimer: "* Fiyatlar pazarlığa açıktır 🙂" },
  ...
  en: {
    ...
    services: { eyebrow: "Services & Pricing", title: "What we offer", note: "Pick what suits you — each service with its price.", free: "Included free", featured: "Most popular", disclaimer: "* Prices are open to negotiation 🙂" },
