...
export const UI = {
  ar: {
    ...
    services: { eyebrow: "الخدمات والأسعار", title: "شو بنقدّملك؟", note: "اختر اللي بناسبك — كل خدمة بسعرها.", free: "مشمول مجاناً", featured: "الأكثر طلباً", disclaimer: "* الأسعار قابلة للتفاوض — والمفاصلة سُنّة 🙂", add: "أضف للطلب", added: "في الطلب ✓", cartTitle: "طلبك", total: "الإجمالي التقديري", checkout: "أرسل الطلب عبر واتساب", remove: "حذف", intro: "مرحبا، مهتم بالخدمات التالية:" },
  ...
  tr: {
    ...
    services: { eyebrow: "Hizmetler & Fiyatlar", title: "Size ne sunuyoruz?", note: "Size uygun olanı seçin — her hizmet kendi fiyatıyla.", free: "Ücretsiz dahil", featured: "En çok tercih edilen", disclaimer: "* Fiyatlar pazarlığa açıktır 🙂", add: "Talebe ekle", added: "Eklendi ✓", cartTitle: "Talebiniz", total: "Tahmini toplam", checkout: "Talebi WhatsApp ile gönder", remove: "Sil", intro: "Merhaba, şu hizmetlerle ilgileniyorum:" },
  ...
  en: {
    ...
    services: { eyebrow: "Services & Pricing", title: "What we offer", note: "Pick what suits you — each service with its price.", free: "Included free", featured: "Most popular", disclaimer: "* Prices are open to negotiation 🙂", add: "Add to request", added: "Added ✓", cartTitle: "Your request", total: "Estimated total", checkout: "Send request via WhatsApp", remove: "Remove", intro: "Hi, I'm interested in these services:" },
